...
if __name__ == "__main__":
    ...
    ax_arr[0, 0].set_xscale("symlog")
    ax_arr[0, 0].plot(np.log(list(range(1, N+1))), np.log(out_tail_arr))
    ax_arr[0, 0].set_title("Out Degree Tail Distribution")
    ax_arr[0, 0].set_xlabel("Out Degree")
    ax_arr[0, 0].set_ylabel("Log of Tail")

    ax_arr[0, 1].set_xscale("symlog")
    ax_arr[0, 1].plot(np.log(list(range(1, N+1))), np.log(in_tail_arr))
    ax_arr[0, 1].set_title("In Degree Tail Distribution")
    ax_arr[0, 1].set_xlabel("In Degree")
    ax_arr[0, 1].set_ylabel("Log of Tail")
